...
module.exports = [
...

  {
    path: "/api/events",
    method: "get",
    response: [200, jsonForRoute("/api/events")]
  },
  ...
  {
    path: "/api/robots/TestBot/events",
    method: "get",
    response: [200, jsonForRoute("/api/robots/TestBot/events")]
  },
  ...
  {
    path: "/api/robots/TestBot/devices/ping/events",
    method: "get",
    response: [200, jsonForRoute("/api/robots/TestBot/devices/ping/events")]
  },
